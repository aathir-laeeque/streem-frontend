...
const DeviateParameterDrawer: FC<{
    ...
    switch (parameterType) {
      case MandatoryParameter.RESOURCE:
        return type === ParameterVariationType.FILTER ? (
          ...
          <ResourceValidation form={form} isReadOnly={false} isVariationView={true} />
        );
      case MandatoryParameter.NUMBER:
        return (
          <NumberValidation
      ...
      case MandatoryParameter.SHOULD_BE:
        return <ParameterParameter form={form} isReadOnly={false} />;
      default:
        return null;
    }
  };
...
export default DeviateParameterDrawer;
