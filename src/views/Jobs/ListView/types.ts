import { Parameter, ParameterVerificationTypeEnum } from '#PrototypeComposer/checklist.types';
...
import { Checklist, ParameterExecutionState, ParameterVerificationStatus } from '#types';
