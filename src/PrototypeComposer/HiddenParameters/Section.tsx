import { Stage, Task } from '#PrototypeComposer/checklist.types';
...
const Section: FC<Props> = ({
  ...
  let isWholeStageSelected = true;
  const parameterIdsInStage: string[] = [];

  const renderTask = (task: Task) => {
    let isWholeTaskSelected = true;
      ...
      <div className="section-task-item" key={task.id}>
        <div className="section-task-item-header">
          <Checkbox
            ...
            disabled={isReadOnly}
            onClick={({ target }) => updateParameterChanges(parameterIdsInTask, target.checked)}
          />
        </div>
    ...
    <AssignmentSectionWrapper>
      <div className="section-header">
        ...
        <Checkbox
          ...
          disabled={isReadOnly}
          onClick={({ target }) => updateParameterChanges(parameterIdsInStage, target.checked)}
        />
      </div>
